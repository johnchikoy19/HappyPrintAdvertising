...
const images = [
    '/images/projectdetails/Teletech/Teletech2.jpg',
    '/images/projectdetails/Teletech/Teletech3.jpg',
    '/images/projectdetails/Teletech/Teletech4.jpg',
    '/images/projectdetails/Teletech/Teletech5.jpg'
                    ...
                    <div className="row">
                        <div className="col-xl-8">
                            <div className="project-thumb d-flex align-self-stretch">
                                <img src="/images/projectdetails/Teletech/Teletech1.jpg" alt=""/>
                            </div>
                        </div>
                        <div className="col-xl-4">
                            <ul className="project-details blue-bg">
                                <li>Project Name<span>Indoor/Outdoor Signages</span></li>
                                <li>Client Name<span>Teletech</span></li>
                            ...
                            <div className="details-content details-content__project">
                                ...
                                <div className="row mt-10">
                                    <div className="col-xl-6 col-lg-6 col-md-6 d-flex mt-30">
                                        <div className="project-item" onClick={() => this.setState({ isOpen: true })} style={{cursor:'pointer'}}>
                                            <div className="project-item__thumb project-item__thumb--big">
                                                <img src="/images/projectdetails/Teletech/Teletech2.jpg" alt=""/>
                                            </div>
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-6 d-flex mt-30">
                                        <div className="project-item" onClick={() => this.setState({ isOpen: true })} style={{cursor:'pointer'}}>
                                            <div className="project-item__thumb project-item__thumb--big">
                                                <img src="/images/projectdetails/Teletech/Teletech3.jpg" alt=""/>
                                            </div>
                                            <div className="project-item__hover" data-overlay="dark" data-opacity="9" hidden>
                                                <a href="project-details.html" className="project-item__link">
                                                    <i className="far fa-arrow-right"></i>
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-6 d-flex mt-30">
                                        <div className="project-item"  onClick={() => this.setState({ isOpen: true })} style={{cursor:'pointer'}}>
                                            <div className="project-item__thumb project-item__thumb--big">
                                                <img src="/images/projectdetails/Teletech/Teletech4.jpg" alt=""/>
                                            </div>
                                            <div className="project-item__hover" data-overlay="dark" data-opacity="9" hidden>
                                                <a href="project-details.html" className="project-item__link">
                                                    <i className="far fa-arrow-right"></i>
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-6 d-flex mt-30">
                                        <div className="project-item" onClick={() => this.setState({ isOpen: true })} style={{cursor:'pointer'}}>
                                            <div className="project-item__thumb project-item__thumb--big">
                                                <img src="/images/projectdetails/Teletech/Teletech5.jpg" alt=""/>
                                            </div>
                                            <div className="project-item__hover" data-overlay="dark" data-opacity="9" hidden>
                                                <a href="project-details.html" className="project-item__link">
                                                    <i className="far fa-arrow-right"></i>
