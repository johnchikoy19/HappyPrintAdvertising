                    ...
                    <div className="row mt-none-30">
                        <div className="col-xl-4 col-lg-6 mt-30">
                            <div className="pricing-item">
                                ...
                                <div className="pricing-item__price pricing-item__price--1 pricing-item__price--white">
                                    <h2>$50.00</h2>
                                </div>
                        ...
                        <div className="col-xl-4 col-lg-6 mt-30">
                            <div className="pricing-item">
                                ...
                                <div className="pricing-item__price pricing-item__price--2 pricing-item__price--white">
                                    <h2>$60.00</h2>
                                </div>
                                <ul className="pricing-item__lists">
                                    <li>Living aboves saying</li>
                        ...
                        <div className="col-xl-4 col-lg-6 mt-30">
                            <div className="pricing-item">
                                ...
                                <div className="pricing-item__price pricing-item__price--3 pricing-item__price--white">
                                    <h2>$70.00</h2>
                                </div>
                                <ul className="pricing-item__lists">
                                    <li>Living aboves saying</li>
