...
export default function ServiceSection() {
    return (
        <>
            ...
            <section className="service-area service-area__2 pt-125 pb-125">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-xl-8 text-center">
                            <div className="section-header section-header__white mb-75">
                                ...
                                <h2 className="section-title section-title__2 section-title__white">quality printing</h2>
                            </div>
                        </div>
                    </div>
                    <div className="row mt-none-50">
                        ...
                        <div className="service-item__content">
                            ...
                            <p>Make your business hard to ignore and can significantly improve the visibility of a business.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-xl-6 col-lg-6 mt-50">
                    <div className="service-item d-flex">
                        ...
                        <h4 className="service-item__title">Safety Signages</h4>
                            <p> Safety solutions for your individual requirements whilst complying with  safety standards.</p>
                        </div>
                    </div>
                </div>
                    </div>
