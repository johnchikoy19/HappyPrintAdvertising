...
const images = [
    '/images/projectdetails/CIMB/cimb2.jpg',
    '/images/projectdetails/CIMB/cimb3.jpg',
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-xl-8">
                            ...
                            <img src="/images/projectdetails/CIMB/cimb1.jpg" alt=""/>
                            </div>
                        </div>
                        <div className="col-xl-4">
                            <ul className="project-details blue-bg">
                                <li>Project Name<span>Pull Up Banner</span></li>
                                <li>Client Name<span>CIMB Bank</span></li>
                    ...
                    <div className="row mt-40">
                        <div className="col-xl-12">
                            <div className="details-content details-content__project">
                                ...
                                <p>Perfect for exhibitors those needing a banner stand for light use, portable and lightweight retractable banner and east to assemble.</p>
                                ...
                                <div className="row mt-10">
                                    ...
                                    <div className="project-item" onClick={() => this.setState({ isOpen: true })} style={{cursor:'pointer'}}>
                                            <div className="project-item__thumb project-item__thumb--big">
                                                <img src="/images/projectdetails/CIMB/cimb2.jpg" alt=""/>
                                            </div>
                                    ...
                                    <div className="project-item" onClick={() => this.setState({ isOpen: true })} style={{cursor:'pointer'}}>
                                            <div className="project-item__thumb project-item__thumb--big">
                                            <img src="/images/projectdetails/CIMB/cimb3.jpg" alt=""/>
                                            </div>
                                            <div className="project-item__hover" data-overlay="dark" data-opacity="9" hidden>
                                                <a href="project-details.html" className="project-item__link">
                                                    <i className="far fa-arrow-right"></i>
