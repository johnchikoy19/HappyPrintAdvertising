                    ...
                    <div className="row justify-content-between">
                        <div className="col-xl-5 pr-0">
                            <div className="about__bg about__bg--3" data-tilt data-tilt-perspective="3000">
                                <img src="/images/about/aboutprint.png" alt="" />
                            </div>
                        </div>
                        <div className="col-xl-6">
                            <div className="section-header section-header__wcu mb-50">
                                ...
                                <h2 className="section-title section-title__2 mb-30">Print mindfully
                                    Green Printing</h2>
                                <p>We aim to help our clients create printed materials of any complexity, while improving our solutions. Our qualified team can put any idea of our customers into reality.</p>
                            </div>
