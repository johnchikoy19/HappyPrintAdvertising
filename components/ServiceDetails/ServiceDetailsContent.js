                                ...
                                <div className="design mt-none-20">
                                    <div className="design-item mt-20">
                                        <div className="design-item--icon">
                                            ...
                                            <img className ="hover" src="/images/icons/design-1-h.png" alt=""/>
                                            </div>
                                        ...
                                        <div className="design-item mt-20">
                                            <div className="design-item--icon">
                                                ...
                                                <img className="hover" src="/images/icons/design-2-h.png" alt=""/>
                                                </div>
                                                <div className="design-item--content">
                                            ...
                                            <div className="design-item mt-20">
                                                <div className="design-item--icon">
                                                    ...
                                                    <img className="hover" src="/images/icons/design-3-h.png" alt=""/>
                                                    </div>
                                                    <div className="design-item--content">
                                                    <h4>Jpg file</h4>
                                                    </div>
                                    ...
                                    <div className="col-xl-8">
                                        <div className="details-content">
                                            <div className="details-content__thumb mb-30">
                                                <img src="/images/bg/service-details-bg-1.jpeg" alt=""/>
                                            </div>
                                            ...
                                            <div className="row mt-35">
                                                <div className="col-xl-12">
                                                    ...
                                                    <div className="details-content__thumb mt-35 mb-35">
                                                        <img src="/images/bg/service-details-bg-2.jpeg" alt=""/>
                                                    </div>
