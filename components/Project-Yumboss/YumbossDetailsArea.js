...
const images = [
    '/images/projectdetails/Yumboss/pb4.jpg',
    '/images/projectdetails/Yumboss/pb2.jpg',
                    ...
                    <div className="row">
                        <div className="col-xl-8">
                            <div className="project-thumb d-flex align-self-stretch">
                                <img src="/images/projectdetails/Yumboss/pb1.jpg" alt=""/>
                            </div>
                        </div>
                        <div className="col-xl-4">
                            <ul className="project-details blue-bg">
                                <li>Project Name<span>Lighted Signages</span></li>
                                <li>Client Name<span>Yumboss Putok Batok Restaurant</span></li>
                    ...
                    <div className="row mt-40">
                        <div className="col-xl-12">
                            <div className="details-content details-content__project">
                                ...
                                <p>Of all illuminated signage options, LED may be the newest kid on the block but not the weakest. In fact, it’s one of the most sought-after lighting solutions because of its unique set of qualities.

                                    Compared with traditional bulbs, LED signages specially in the Philippines stand out in the brightness, longevity, lightweightness, aesthetic versatility, and energy efficiency departments.  In general, custom LED signs can stay in mint condition with carefree maintenance.</p>
                                ...
                                <div className="row mt-10">
                                    <div className="col-xl-6 col-lg-6 col-md-6 d-flex mt-30">
                                        <div className="project-item"  onClick={() => this.setState({ isOpen: true })} style={{cursor:'pointer'}}>
                                            <div className="project-item__thumb project-item__thumb--big">
                                                <img src="/images/projectdetails/Yumboss/pb4.jpg" alt=""/>
                                            </div>
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-6 d-flex mt-30">
                                        <div className="project-item" onClick={() => this.setState({ isOpen: true })} style={{cursor:'pointer'}}>
                                            <div className="project-item__thumb project-item__thumb--big">
                                                <img src="/images/projectdetails/Yumboss/pb2.jpg" alt=""/>
                                            </div>
                                            <div className="project-item__hover" data-overlay="dark" data-opacity="9" hidden>
                                                <a href="project-details.html" className="project-item__link">
                                                    <i className="far fa-arrow-right"></i>
