...
const images = [
    '/images/projectdetails/Prime/primesearch2.jpg',
    '/images/projectdetails/Prime/primesearch3.jpg',
    '/images/projectdetails/Prime/primesearch4.jpg',
                    ...
                    <div className="row">
                        <div className="col-xl-8">
                            <div className="project-thumb d-flex align-self-stretch">
                                <img src="/images/projectdetails/Prime/primesearch1.jpg" alt=""/>
                            </div>
                        </div>
                        <div className="col-xl-4">
                            <ul className="project-details blue-bg">
                                <li>Project Name<span>Car Decals/Stickers</span></li>
                                <li>Client Name<span>PrimeSearch</span></li>
                    ...
                    <div className="row mt-40">
                        <div className="col-xl-12">
                            <div className="details-content details-content__project">
                                ...
                                <p>Easy-to-use design tool allows you to quickly create a sticker online using customizable templates, personalized text, and a huge library of beautiful clipart. </p>
                                ...
                                <div className="row mt-10">
                                    ...
                                    <div className="project-item" onClick={() => this.setState({ isOpen: true })} style={{cursor:'pointer'}}>
                                            ...
                                            <img src="/images/projectdetails/Prime/primesearch2.jpg" alt=""/>
                                            </div>
                                    ...
                                    <div className="project-item" onClick={() => this.setState({ isOpen: true })} style={{cursor:'pointer'}}>
                                            <div className="project-item__thumb project-item__thumb--big">
                                            <img src="/images/projectdetails/Prime/primesearch3.jpg" alt=""/>
                                            </div>
                                            <div className="project-item__hover" data-overlay="dark" data-opacity="9" hidden>
                                                <a href="project-details.html" className="project-item__link">
                                                    <i className="far fa-arrow-right"></i>
                                    ...
                                    <div className="project-item" onClick={() => this.setState({ isOpen: true })} style={{cursor:'pointer'}}>
                                            <div className="project-item__thumb project-item__thumb--big">
                                            <img src="/images/projectdetails/Prime/primesearch4.jpg" alt=""/>
                                            </div>
                                            <div className="project-item__hover" data-overlay="dark" data-opacity="9" hidden>
                                                <a href="project-details.html" className="project-item__link">
                                                    <i className="far fa-arrow-right"></i>
