                    ...
                    <div className="cat" style={{  textAlign: 'center', marginBottom:'50px'}}>
                        ...
                        >
                          <Card css={{ $$cardColor: '$colors$primary' }}>
                            ...
                            <Image src="/images/subservices/graphics/logo.jpg" alt="blog image"  width={300}
                        height={400} />
                            </Card.Body>
                        </Card>
                      ...
                      Stand out from the crowd with a logo that fits your brand personality.
                        ...
                        >
                           <Card css={{ $$cardColor: '$colors$warning' }}>
                            ...
                            <Image src="/images/subservices/graphics/letterhead.png" alt="blog image"  width={300}
                        height={400} />
                            </Card.Body>
                        </Card>
                        ...
                        <Image src="/images/subservices/graphics/mosaic.png" alt="blog image"  width={300}
                        height={400} />
                        </Card.Body>
                        </Card>
