            ...
            <div className="details-content-area pt-125 pb-125">
                <div className="container">
                    ...
                    <div className="cat" style={{  textAlign: 'center', marginBottom:'50px'}}>
                        ...
                        Make your business billboards be trusted, highly visible and to a safe place.
                                                    </Text>
                        ...
                        >
                           <Card css={{ $$cardColor: '$colors$warning' }}>
                            ...
                            <Image src="/images/services/signage.png" alt="blog image"  width={300}
                        height={400} />
                            </Card.Body>
                        </Card>
                        ...
                        style={{  backgroundColor: '#f5a524',borderRadius:'25px'}}>
                          <Text h6 size={32} color="white" css={{ m: 0 }} style={{margin:'auto', width:'80%',textAlign:'center',marginTop:'40px'}}>
                          Signages that can be installed in residential and commercial spaces that are sure to delight your guests and customers.
                                                    </Text>
                        </BackSide>
                    </Flippy>
