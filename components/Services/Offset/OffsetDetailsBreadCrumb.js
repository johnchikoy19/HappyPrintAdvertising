...
export default function AdvertisingDetailsBreadCrumb() {
    return (
        <>
            ...
            <section className=" pt-180 pb-180 bg_img" style={{"background":"url(/images/services/offsetback.png)","backgroundRepeat":"no-repeat","backgroundSize":"100%","backgroundSize":'cover', "objectFit": "cover"}}
