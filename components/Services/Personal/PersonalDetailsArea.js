        ...
        <>
            ...
            <div className="details-content-area pt-125 pb-125">
                <div className="container">
                    ...
                    <div className="cat" style={{  textAlign: 'center', marginBottom:'50px'}}>
                        ...
                        >
                          <Card css={{ $$cardColor: '$colors$primary' }}>
                            ...
                            <Image src="/images/subservices/personalize/dropbox.jpg" alt="blog image"  width={300}
                        height={400} />
                            </Card.Body>
                        </Card>
                      ...
                      <Text h6 size={32} color="white" css={{ m: 0 }} style={{margin:'auto', width:'80%',textAlign:'center',marginTop:'40px'}}>
                          Offering customize design for your own business dropbox.
                                                    </Text>
                        </BackSide>
                    </Flippy>
                        ...
                        >
                          ...
                          Menu
                            ...
                            <Image src="/images/subservices/personalize/foodmenu.jpg" alt="blog image"  width={300}
                        height={400} />
                            </Card.Body>
                        </Card>
                  ...
                  <Text h6 size={32} color="white" css={{ m: 0 }} style={{margin:'auto', width:'80%',textAlign:'center',marginTop:'40px'}}>
                  Set the tone for the products and services that your customers can expect from you. 
                                                    </Text>
                        </BackSide>
                    </Flippy>
                        ...
                        <div className="col-xl-4">
                           ...
                           Stainless Design
                            ...
                            <Image src="/images/subservices/personalize/stainless.png" alt="blog image"  width={300}
                            height={400} />
                            </Card.Body>
                            </Card>
                            ...
                            style={{  backgroundColor: '#37b546',borderRadius:'25px'}}>
                                 <Text h6 size={32} color="white" css={{ m: 0 }} style={{margin:'auto', width:'80%',textAlign:'center',marginTop:'40px'}}>
                                Have a customize printing design for your stainless design products.
                                                    </Text>
                            </BackSide>
                            </Flippy>
