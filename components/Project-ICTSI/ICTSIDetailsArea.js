...
const images = [
    '/images/projectdetails/sign/sign2.jpg',
    '/images/projectdetails/sign/sign3.jpg',
    '/images/projectdetails/sign/sign4.jpg'
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-xl-8">
                            ...
                            <img src="/images/projectdetails/sign/sign1.jpg" alt="" />
                            </div>
                        </div>
                        <div className="col-xl-4">
                            <ul className="project-details blue-bg">
                                <li>Project Name<span>Outdoor Signages</span></li>
                                <li>Client Name<span>ICTSI</span></li>
                    ...
                    <div className="row mt-40">
                        <div className="col-xl-12">
                            <div className="details-content details-content__project">
                                ...
                                <p>Outdoor signage is a signage that is installed on the exterior of your business, or in another location. This could be stand-alone, placed on a billboard or hoardings as part of an advert or marketing campaign, or used at an event. It could also be attached to your business premises to maximise on free space and alert people to your presence via building wraps, shop signs and architectural signage.</p>
                                ...
                                <div className="row mt-10">
                                    ...
                                    <div className="project-item" onClick={() => this.setState({ isOpen: true })} style={{cursor:'pointer'}}>
                                            ...
                                            <img src="/images/projectdetails/sign/sign2.jpg" alt="" />
                                            </div>
                                    ...
                                    <div className="project-item" onClick={() => this.setState({ isOpen: true })} style={{cursor:'pointer'}}>
                                            <div className="project-item__thumb project-item__thumb--big">
                                            <img src="/images/projectdetails/sign/sign3.jpg" alt="" />
                                            </div>
                                            <div className="project-item__hover" data-overlay="dark" data-opacity="9" hidden>
                                                <a href="project-details.html" className="project-item__link">
                                                    <i className="far fa-arrow-right"></i>
                                    ...
                                    <div className="project-item" onClick={() => this.setState({ isOpen: true })} style={{cursor:'pointer'}}>
                                            <div className="project-item__thumb project-item__thumb--big">
                                            <img src="/images/projectdetails/sign/sign4.jpg" alt="" />
                                            </div>
                                            <div className="project-item__hover" data-overlay="dark" data-opacity="9" hidden>
                                                <a href="project-details.html" className="project-item__link">
                                                    <i className="far fa-arrow-right"></i>
